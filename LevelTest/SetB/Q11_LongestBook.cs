...
// Q11에서 사용되는 책 구조체. (시험 문제이므로 구조체 정의는 미리 제공됩니다)
public struct Book
{
    public string Title;
    public int Pages;
...
public static class Q11_LongestBook
{
    // Q11 (구조체 - 탐색) : 페이지 수가 가장 많은 책의 제목 반환
    //
    // 문제 설명:
    ...
    public static void Check() => Grader.Run("Q11 (가장 두꺼운 책)", Inputs, Expected, Solve);
}
